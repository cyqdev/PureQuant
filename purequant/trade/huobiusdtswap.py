"""
火币永续合约
https://huobiapi.github.io/docs/usdt_swap/v1/cn/#6b15dcb6a3
Author: Gary-Hertel
Date:   2020/11/21
...
class HUOBIUSDTSWAP:
    ...
    def get_funding_rate(self):
        """获取最新资金费率"""
        data = requests.get("https://api.hbdm.com/linear-swap-api/v1/swap_funding_rate?contract_code=%s" % self.__instrument_id).json()
