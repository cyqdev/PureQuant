...
class BYBITFUTURES:
    ...
    def get_order_info(self, order_id):
        ...
        if result['result']['order_status'] == "Filled":
            ...
            dict = {"交易所": "BYBIT反向合约", "币对": self.__symbol, "方向": action, "订单状态": "失败", "order_id": order_id}
            return dict
            ...
            dict = {"交易所": "BYBIT反向合约", "币对": self.__symbol, "方向": action, "订单状态": "等待成交", "order_id": order_id}
            return dict
            ...
            dict = {"交易所": "BYBIT反向合约", "币对": self.__symbol, "方向": action, "订单状态": "等待", "order_id": order_id}
            return dict
